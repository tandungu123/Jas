...
module.exports.run = async ({ event, api, args, client, Currencies, Users, utils, global }) => {
	const content = args.join()
			...
			return api.sendMessage(`Bạn có 15 giây để trả lời ===\n ${value1} ${operation} ${value2} = ?`, event.threadID, (err, info) => global.reply.push({ type: "domath", messageID: info.messageID, target: parseInt(threadID), author: senderID, answer }), event.messageID);
		}