...
module.exports.handleEvent = async ({
    ...
    var u = [`=====Thông báo từ admin=====\n\n👀Bot đã thấy được việc chửi bot của ${1}\\n⏱Đã chửi bot vào lúc: ${m}\n\n📞Đã báo về Admin\n\n📌Con ôn ${1} m ngon chửi tao lần nữa xem\n\n☎️liên hệ Admin:m.me/wall.NguyenTanHuy.no1 để có cơ hội được sám hối\n\n❗️Mong trường hợp như trên không tái hiện lần 2.Xin cảm ơn\n\n================================`],
